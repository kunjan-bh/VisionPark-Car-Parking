document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('location').addEventListener('change', function() {
        ...
        if (selectedLocation === "Maitidevi-Sunway") {
            ...
            // vacantDiv.style.display = 'none';
            alert('No slots available at the moment for the selected location.');
        }
    });
    // document.getElementById("selected_slot").addEventListener("change", function() {
    //     var slotId = this.value;
    //     var vacantDiv = document.getElementById("vacant");
    //     vacantDiv.style.display = "block";
    //     if (slotId) {
    //         vacantDiv.style.display = "block";
    //     } else {
    //         vacantDiv.style.display = "none";
    ...
    document.getElementById('slots').addEventListener('click', function(event) {
        if (event.target && event.target.matches('.slot-btn')) {
            const slotButtons = document.querySelectorAll('.slot-btn');
            // var vacantDiv = document.getElementById("vacant");
            // const vacantDiv = document.getElementById("vacant");
